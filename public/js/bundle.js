...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGF4eTIzIiwiYSI6ImNrdmhva3RhaTRiMHUybmx1ZzZnZmNqZWUifQ.9scWjQ91zQmzvHL5KQMCoA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/laxy23/cl8bheq52007q14qqo922fsid',
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, data) {
    var dt, options, url, form, response, _data;

    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            dt = _objectSpread({}, data);
            options = {
              method: 'PATCH'
            };
            _context.prev = 2;
          ...
          case 12:
            ...
            if (_data.status === 'success') {
              (0, _alerts.showAlert)('success', "Updated User ".concat(type, " successfully"), 2000);
            }
          ...
          case 16:
            ...
            _context.t0.text().then(function (errorMessage) {
              (0, _alerts.showAlert)('error', JSON.parse(errorMessage).message, 5000);
            });
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var stripe, res, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LmVwsK3bT010ANy16pNw8COqp5RZIDQXDgies12NiTRN1P7tJgOyqCF1vza8zibb5JsI0eKeLW1aHKokAob39HA00bwN0qMew');
            _context.prev = 1;
            _context.next = 4;
            return fetch("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId));
...
var userPswForm = document.querySelector('.form-user-settings');
...
if (userPswForm) {
  userPswForm.addEventListener('submit', /*#__PURE__*/function () {
